...
class TriviaTestCase(unittest.TestCase):
    ...
    def test_delete_question(self):
        question = Question(question='What is my name?', answer='Waris', difficulty=1, category="1")
        question.insert()
        ...
        self.assertEqual(res.status_code, 200)
        self.assertEqual(data['success'], True)
        self.assertEqual(data['deleted_question'], deleted_question_id)
    ...
    def test_play_quiz(self):
        ...
        res = self.client().post('/questions/play', json=new_quiz_round)
        data = json.loads(res.data)
